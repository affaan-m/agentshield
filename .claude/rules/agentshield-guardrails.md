...
- add-new-security-rule: Adds one or more new security detection rules to the scanner (e.g., for agents, hooks, permissions, MCP, secrets), including implementation and associated tests.
