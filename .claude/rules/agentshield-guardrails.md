...
- Prefer `conventional` commit messaging with prefixes such as feat, chore, fix.
...
- add-or-update-ecc-bundle-component: Adds or updates an ECC bundle component, such as configuration or documentation, for the agentshield project.
- add-or-update-team-config: Adds or updates the team configuration for agentshield, typically in JSON format.
