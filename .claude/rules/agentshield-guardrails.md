...
- add-or-update-ecc-bundle-component: Add or update a component of the agentshield ECC bundle, such as commands, team config, research playbooks, guardrails, or skills.
- add-or-update-codex-agent-config: Add or update agent configuration files for Codex agents (docs-researcher, reviewer, explorer).
